import { Color, DoubleSide, Matrix4, Mesh, Vector3, Vector2 } from "three";
...
class Text extends Mesh {
          ...
          (textRenderInfo) => {
            ...
            if (!this._materialReady) {
              ...
              if (
                material &&
                material.uniforms &&
                material.uniforms.uTroikaSDFTexture
              ) {
                material.uniforms.uTroikaSDFTexture.value =
                  textRenderInfo.sdfTexture;
              }
              if (
                material &&
                material.uniforms &&
                material.uniforms.uTroikaIsMSDF
              ) {
                material.uniforms.uTroikaIsMSDF.value = textRenderInfo.isMSDF
                  ? 1
                  : 0;
              }
            }
  ...
  _prepareForRender(material) {
    ...
    if (textInfo) {
      ...
      if (
        uniforms.uTroikaSDFTextureSize &&
        uniforms.uTroikaSDFTextureSize.value
      ) {
      ...
      if (
        uniforms.uTroikaSDFGlyphSize &&
        uniforms.uTroikaSDFGlyphSize.value !== undefined
      ) {
